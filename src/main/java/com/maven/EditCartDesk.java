...
public class EditCartDesk extends Parent {

	public void editCartDesk() throws Exception {
		...
		try {
			...
			if (comparedURL == true) {
				...
				// Confirming cart page is working for desktop
				System.out.print("On view bag: Cart page is working for desktop - Passed\n");

			} else {

				// Confirming cart page is not working for desktop
				System.out.print("On view bag: Cart page is not working for desktop - Failed\n");
				Thread.sleep(2000);
				driver.quit();
				System.out.print("                ***********     \n");
			...
			// Confirming edit cart is working for desktop
			System.out.print("Edit cart is working for desktop - Passed\n");

		} catch (Exception e) {

			// Confirming edit cart is not working for desktop
			System.out.print("Edit cart is not working for desktop - Failed\n");
			Thread.sleep(2000);
			driver.quit();
			System.out.print("                ***********     \n");
		}
