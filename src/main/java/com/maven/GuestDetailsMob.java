...
public class GuestDetailsMob extends Parent {

	public void guestDetailsMob() throws Exception {
		...
		try {
			...
			System.out.print("Guest details on checkout are working for mobile - Passed\n");

		} catch (Exception e) {

			// Confirming Guest details on checkout is not working
			System.out.print("Guest details on checkout are not working for mobile - Failed\n");
			driver.quit();
			System.out.print("                ***********     \n");
