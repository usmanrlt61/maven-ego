...
public class FindProdDesk extends Parent {
	Boolean comparedURL = false;

	public void findProductDesk() throws Exception {
		...
		try {
			...
			if (comparedURL == true) {
				...
				// Confirming find product is working for desktop
				System.out.print("Find product is working for desktop - Passed\n");

			} else {

				// Confirming find product is not working for desktop
				System.out.print("Find product is not working for desktop - Failed\n");
				Thread.sleep(2000);
				driver.quit();
				System.out.print("                ***********     \n");
